...
function showActiveTheme(theme) {
  ...
  const userAvatarIcon = document.querySelector("#navbarDropdownMenuAvatar i.fas");
  if (userAvatarIcon) {
    userAvatarIcon.classList.toggle("text-light", theme === "dark");
    userAvatarIcon.classList.toggle("text-dark", theme !== "dark");
  }
}

// Change body theme early to prevent flash
let currentTheme = getPreferredTheme();
document.documentElement.setAttribute("data-mdb-theme", currentTheme);
